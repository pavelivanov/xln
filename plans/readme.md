...
|---|---|---|
| [Migration work plan](react-frontend-migration.md) | `IN PROGRESS — WP0–WP6 + WP8 COMPLETE; WP7 WORKSPACE PARTIAL; WP9 HAS 18 COVERED / 2 PARTIAL / 0 MISSING ROUTES AND 5 EXACT GAPS` | Exercise populated portfolio and financial-health views against committed Runtime state. |
...
| Frontend implementation | `IN PROGRESS — 18 COVERED / 2 PARTIAL ROUTES; WALLET PORTFOLIO + HEALTH DEPTH NEXT` | Keep the next `/app` slice read-only and prove it at all required viewports. |
