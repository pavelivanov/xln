<script lang="ts">
  ...
  $: ({ activeDispute, disputeTimeoutSeconds, hasObservedDisputeDeadline, disputeSecondsLeft, pendingSecretAckInfo } = buildAccountDisputeView(account, replica, counterpartyId, nowMs));
