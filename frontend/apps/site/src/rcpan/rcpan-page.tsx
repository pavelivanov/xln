...
import { cloneMicroscopeControls, type RcpanMicroscopeControls, type RcpanScenarioId } from '../../../../packages/ui/src/rcpan/microscope/microscope-playground';
import { deriveRcpanMicroscopeFrame } from '../../../../packages/ui/src/rcpan/microscope/microscope-model';
import { deriveMicroscopeTimeline, phaseStartMs } from '../../../../packages/ui/src/rcpan/microscope/microscope-timeline';
