import { requireRuntimeEnum, requireRuntimeInteger, requireRuntimeRecord, requireRuntimeString, normalizeRequiredRuntimeEntityId } from '../runtime/wallet-runtime-decode';
