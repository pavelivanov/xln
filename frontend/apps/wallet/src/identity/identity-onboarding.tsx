...
import type { WalletCanonicalRecoveryDiscoveryView } from '../../../../packages/browser/src/runtime/wallet-runtime-opening';
import type { WalletBrainVaultDerivationProgress, WalletBrainVaultPreparedView } from '../../../../packages/browser/src/identity/wallet-brainvault-opening';
import { selectWalletIdentityMode, type WalletIdentityMode } from '../../../../packages/browser/src/identity/wallet-identity-entry';
...
import { createMnemonicWalletOpeningRequest, importWalletIdentityRecoveryFile } from '../onboarding/wallet-identity-opening';
import { resetWalletRecoveryRehearsal, type WalletRecoveryRehearsalState } from '../../../../packages/browser/src/recovery/wallet-recovery-rehearsal';
import {
...
import '../styles/onboarding/identity-onboarding.css';
