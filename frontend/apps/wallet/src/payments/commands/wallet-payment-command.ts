...
const loadCommandDependencies = (): Promise<CommandDependencies> => {
  commandDependencies ??= Promise.all([
    import('../../../../../packages/browser/src/commands/runtime-command-intent.ts'),
    import('../../../../../packages/browser/src/commands/runtime-command-intent-codec.ts'),
    import('../../../../../packages/browser/src/commands/runtime-command-journal-keyring.ts'),
    import('../../../../../packages/runtime-client/src/runtime/runtime-failure.ts'),
