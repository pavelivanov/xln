import type { RuntimePaymentEntityTx, RuntimePaymentInput } from '../../../../packages/runtime-client/src/payments/payment-command-types';
import type { WalletPaymentMath, WalletPaymentProjection } from '../payments/wallet-payment-model';
import { buildWalletEntityTxInput } from '../payments/wallet-payment-model';
