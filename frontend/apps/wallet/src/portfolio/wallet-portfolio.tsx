...
const WalletFormation = lazy(async () => ({ default: (await import('../onboarding/wallet-formation')).WalletFormation }));
const WalletHubDiscovery = lazy(async () => ({ default: (await import('../onboarding/wallet-hub-discovery')).WalletHubDiscovery }));
const WalletFocusedAccount = lazy(async () => ({ default: (await import('../account/view/wallet-account-view')).WalletFocusedAccount }));
const WalletAccountAppearance = lazy(async () => ({ default: (await import('../account/controls/wallet-account-appearance')).WalletAccountAppearance }));
const WalletAccountDropdown = lazy(async () => ({ default: (await import('../account/controls/wallet-account-dropdown')).WalletAccountDropdown }));
