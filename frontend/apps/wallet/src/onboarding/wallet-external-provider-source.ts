...
} from '../../../../packages/browser/src/wallet/wallet-external-provider';
import { walletExternalCompletionMessage } from '../../../../packages/browser/src/wallet/wallet-external-provider';
