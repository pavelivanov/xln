...
import { components, panels, createInternalWorkspacePanels, createFullWorkspacePanels } from './session/ops-workspace-panels';

import { WorkspaceDock } from '../../../../packages/ui/src/workspace/workspace-dock';
import { OpsWorkspaceNavigation, OpsWorkspaceJurisdictionNavigation, OpsWorkspaceIdentityNavigation, OpsWorkspaceWalletNavigation } from './session/ops-workspace-navigation';
import { OpsShell } from '../ops-shell';
import { OpsWorkspaceTimeline } from './session/ops-workspace-timeline';
import { workspaceBoot, workspaceNetwork } from './session/ops-workspace-playback';
import { OpsOwnerUnlock } from './owner/ops-owner-unlock';
import { OpsLocaleSelector } from './ops-locale-selector';
import { OpsWorkspaceGuide } from './guide/ops-workspace-guide';
