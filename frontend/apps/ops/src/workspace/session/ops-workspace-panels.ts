...
import { OpsEntityPanel } from '../entity/ops-entity-panel';
import { OpsGossipPanel } from '../panels/ops-gossip-panel';
import { OpsSolvencyPanel } from '../panels/ops-solvency-panel';
import { OpsRuntimeDiagnosticsPanel } from '../runtime/ops-runtime-diagnostics-panel';
import { OpsDatabaseInspector } from '../panels/ops-database-inspector';
import { OpsRuntimeManager } from '../runtime/ops-runtime-manager';
import { OpsConsolePanel } from '../panels/ops-console-panel';
import { OpsRuntimeIoPanel } from '../runtime/ops-runtime-io-panel';
import { OpsJMachineInspector } from '../jurisdiction/ops-jmachine-inspector';
import { OpsEntityAuditPanel } from '../entity/ops-entity-audit-panel';
import { OpsGraphPanel } from '../graph/ops-graph-panel';
import { OpsSettingsPanel } from '../settings/ops-settings-panel';
import { OpsWalletPanel } from '../panels/ops-wallet-panel';
import { OpsJurisdictionPanel } from '../jurisdiction/ops-jurisdiction-panel';
import { OpsArchitectPanel } from '../panels/ops-architect-panel';
import { OpsBrainVaultPanel } from '../panels/ops-brainvault-panel';
