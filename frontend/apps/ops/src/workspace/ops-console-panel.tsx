...
import { CONSOLE_MAX_LOGS, consoleCommandCompletions, consoleLevelColor, createConsoleCommands, evalConsoleCommand, filterConsoleLogs, formatConsoleLogText, projectConsoleFrameLogs, type ConsoleEntry, type ConsoleFilterLevel } from '../../../../packages/runtime-client/src/console-panel-view';
...
import { loadWorkspaceScenario } from './ops-workspace-playback';
