...
import type { WalletCommandDraft } from '../../../wallet/src/wallet-command-draft';
...
import { OpsBoundEntityPanel } from './ops-entity-panel';
import { OpsRuntimeDiagnosticsPanel } from './ops-runtime-diagnostics-panel';
import { WalletRuntimeScope } from '../../../wallet/src/wallet-runtime-scope';
import { borrowWalletRuntimeReadDependencies } from '../../../wallet/src/wallet-runtime-read-boundary';
import { WalletNavigationScope } from '../../../wallet/src/wallet-navigation';
import { resolveWalletAppRoute, walletPaymentTabHref } from '../../../wallet/src/wallet-navigation-model';
import { WalletWorkspaceSelection } from '../../../wallet/src/wallet-workspace-selection';
import { WalletAccountRail } from '../../../wallet/src/wallet-account-rail';
import { WalletPortfolio } from '../../../wallet/src/wallet-portfolio';
import { WalletExistingSetupGate } from '../../../wallet/src/wallet-onboarding';
import { useOpenWorkspaceIdentity } from './ops-workspace-navigation';

type WalletNavigation = Readonly<{ id: number; href: string; runtimeId?: string; command?: WalletCommandDraft }>;

const WalletPayments = lazy(async () => ({ default: (await import('../../../wallet/src/wallet-payments')).WalletPayments }));
const WalletMarkets = lazy(async () => ({ default: (await import('../../../wallet/src/wallet-markets')).WalletMarkets }));
const WalletAccountWorkspace = lazy(async () => ({ default: (await import('../../../wallet/src/wallet-account-workspace')).WalletAccountWorkspace }));
const WalletFinancialHealth = lazy(async () => ({ default: (await import('../../../wallet/src/wallet-financial-health')).WalletFinancialHealth }));
