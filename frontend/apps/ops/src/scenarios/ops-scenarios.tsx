...
import type { RuntimeScenarioSnapshot } from '../../../../packages/browser/src/runtime/session/runtime-scenario-source';
import { SCENARIO_OPTIONS, type ScenarioId } from '../../../../packages/runtime-client/src/scenario/scenario-player-model';
