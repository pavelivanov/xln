import { registerBrowserRuntimeEnvironment } from '../../runtime/browser/browser-runtime-context';
...
import type { WalletEmbeddedRuntimeResource } from '../../../packages/browser/src/runtime/wallet-embedded-runtime-session';
import { WalletRecoverySelectionSession } from '../../../packages/browser/src/recovery/wallet-recovery-selection-session';
import { WalletBrainVaultMaterialSession } from '../../../packages/browser/src/identity/wallet-brainvault-material-session';
import type {
...
import { parseRuntimeRecoveryCandidateFile } from '../../vault/recovery/vault-recovery';
import {
...
import type { RuntimeRecoveryCandidate } from '../../vault/recovery/vault-recovery';
