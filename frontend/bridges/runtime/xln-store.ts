...
import { waitForObservedRemoteCommand } from '../../src/lib/stores/commands/remote-command-observation';
import {
...
} from '../../packages/runtime-client/src/runtime/p2p-prefetch';
import { requireTokenDecimals } from '../../packages/runtime-client/src/token-metadata';
import { getXLN, xlnInstance } from './xln-runtime-loader';
...
export { xlnEnvironment, setXlnEnvironment } from './embedded-runtime-store';
