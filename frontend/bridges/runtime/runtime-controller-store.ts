...
export const runtimeAdapter = createObservableStore<RuntimeAdapter | null>(null);
export const runtimeControllerHandle = createObservableStore<RuntimeHandle>(emptyHandle);
export const runtimeControllerConfig = createObservableStore<RuntimeAdapterConfig | null>(null);
export const runtimeAdapterStatus = createObservableStore<RuntimeAdapterStatus>('disconnected');
export const runtimeAdapterHeight = createObservableStore<number>(0);
