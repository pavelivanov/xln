...
import { hasPersistedWalletVault } from '../../../packages/browser/src/wallet/wallet-vault-storage';
import { bootEmbeddedRuntimeAdapter } from './browser-runtime-adapter';
...
export const bootWalletEmbeddedRuntime = async (
  ...
  if (hasPersistedWalletVault(localStorage)) {
    const canonical = await import('../../wallet/canonical/wallet-canonical-vault-runtime');
