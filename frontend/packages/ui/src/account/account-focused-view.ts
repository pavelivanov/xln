import type { AccountTx, EntityState } from '@xln/core/api/public/runtime-module';
import type { AccountReadView, EntityReadView } from '../../../runtime-client/src/entity/entity-panel-types';
import { isAccountLeftPerspective } from './account-token-details';
...
export function buildAccountActivityRows(account: AccountReadView, entityId: string): AccountActivityRow[] {
...
export function buildAccountDisputeDeadline(
  activeDispute: Pick<NonNullable<AccountReadView['activeDispute']>, 'disputeTimeout' | 'observedOnChain'> | null,
  nowMs: number,
) {
...
export function buildAccountDisputeView(account: AccountReadView, replica: EntityReadView | null, counterpartyId: string, nowMs: number) {
