...
export const isRelayTimelineError = (event: RelayTimelineEvent): boolean => relayTimelineTone(event) === 'error';

export const isRelayTimelineWarning = (event: RelayTimelineEvent): boolean => relayTimelineTone(event) === 'warning';
