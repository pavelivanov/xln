import type { AccountReplica, Delta, DerivedDelta } from '@xln/core/api/public/runtime-module';
import { ZeroAddress } from 'ethers';
import { isMapLike } from '../../../../runtime-client/src/boundary';
import { amountToUsd, getAssetUsdPrice } from '../../../../runtime-client/src/asset-pricing';
...
type DeriveDelta = (delta: Delta, isLeft: boolean) => DerivedDelta;
...
export function buildAccountPortfolioData(options: {
  ...
  deriveDelta: DeriveDelta | undefined;
  getTokenInfo: (tokenId: number) => AssetTokenInfo;
