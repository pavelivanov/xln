import type { AccountReadView } from './entity-panel-types';
import { amountToUsd } from '../asset-pricing';
...
export function resolveCollateralFeePolicy(account: AccountReadView | null | undefined, ownerEntityId: string, tokenId: number) {
...
export function buildCollateralRequest(account: AccountReadView, entityId: string, counterpartyEntityId: string, tokenId: number, amount: bigint) {
