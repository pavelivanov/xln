...
export const CAPABILITIES = [
  ...
  },
  {
    ...
    behavior: [
      ...
      'framework-neutral Entity workspace deep-link state, top-level and Settings section registries, strict identity/context, committed reserve, committed-board, bounded consensus-evidence, paged Account frame-header, public profile, and shared theme projections',
      'React candidate-only identity-first Entity shell with canonical hash-backed tabs, a tab-confined remote Runtime read boundary, read-only Assets, Ownership, Accounts, Consensus, and profile evidence, plus a shared-storage Display theme control',
