...
export const CAPABILITIES = [
  ...
  },
  {
    ...
    behavior: [
      ...
      'framework-neutral Entity workspace deep-link state, top-level and Settings section registries, strict identity/context, committed reserve, committed-board, bounded consensus-evidence, paged Account frame-header, persisted activity, public profile, shared theme, and exact Time Machine state projections',
      'React candidate-only identity-first Entity shell with canonical hash-backed tabs, a tab-confined remote Runtime read boundary, read-only Assets, Ownership, Accounts, persisted activity, Consensus, and profile evidence, plus shared-storage Display controls and exact historical-frame navigation',
