...
export const CAPABILITIES = [
  ...
  },
  {
    ...
    currentSources: [
      ...
      'frontend/packages/browser/src/wallet-onboarding.ts',
      'frontend/packages/browser/src/wallet-formation.ts',
      ...
      'frontend/packages/browser/src/wallet-brainvault-opening.ts',
      ...
      'frontend/apps/wallet/src/identity-entry-form.tsx',
      ...
      'frontend/bridges/wallet-brainvault-worker-runtime.ts',
  ...
  },
  {
    ...
    currentSources: [
      ...
      'frontend/apps/wallet/src/wallet-runtime-scope.tsx',
  ...
  },
  {
    ...
    currentSources: [
      ...
      'frontend/packages/runtime-client/src/withdrawable-collateral.ts',
      'frontend/apps/wallet/src/wallet-entity-evidence.tsx',
  ...
  },
  {
    ...
    currentSources: [
      ...
      'frontend/packages/runtime-client/src/entity-workspace-activity.ts',
      ...
      'frontend/packages/runtime-client/src/entity-workspace-profile-update.ts',
      ...
      'frontend/packages/ui/src/entity-workspace-display-panel.tsx',
      'frontend/packages/ui/src/entity-workspace-display-panel.css',
      'frontend/packages/ui/src/entity-workspace-settings-stage.tsx',
      'frontend/packages/ui/src/entity-workspace-settings-stage.css',
      ...
      'frontend/packages/ui/src/entity-workspace-profile-editor.tsx',
      'frontend/packages/ui/src/entity-workspace-profile-editor.css',
      'frontend/packages/ui/src/entity-workspace-reserves-panel.tsx',
      'frontend/packages/ui/src/entity-workspace-reserves-panel.css',
      ...
      'frontend/apps/ops/src/workspace/ops-settings-panel.tsx',
      'frontend/apps/ops/src/workspace/ops-settings-camera.tsx',
      'frontend/apps/ops/src/workspace/ops-settings-presentation.tsx',
      'frontend/apps/ops/src/workspace/ops-runtime-policies.tsx',
      ...
      'frontend/apps/ops/src/ops-entity-workspace-profile-command.ts',
      'frontend/apps/ops/src/ops-entity-workspace-owner.ts',
      ...
      'frontend/packages/ui/src/command-palette-view.ts',
      'frontend/packages/ui/src/command-palette-suggestions.ts',
      'frontend/apps/wallet/src/wallet-command-draft.ts',
      'frontend/apps/ops/src/workspace/ops-workspace.tsx',
      'frontend/apps/ops/src/workspace/ops-workspace-panels.ts',
      'frontend/apps/ops/src/workspace/ops-pinned-tab.tsx',
      'frontend/apps/ops/src/workspace/ops-workspace-session.ts',
      'frontend/apps/ops/src/workspace/ops-recorded-entity.ts',
      'frontend/apps/ops/src/workspace/ops-owner-unlock.tsx',
      'frontend/apps/ops/src/workspace/ops-runtime-manager.tsx',
      'frontend/apps/ops/src/workspace/ops-runtime-selection.ts',
      'frontend/apps/ops/src/workspace/ops-entity-panel.tsx',
      'frontend/apps/ops/src/workspace/ops-entity-audit-panel.tsx',
      'frontend/apps/ops/src/workspace/ops-console-panel.tsx',
      'frontend/apps/ops/src/workspace/ops-runtime-io-panel.tsx',
      'frontend/apps/ops/src/workspace/ops-jmachine-inspector.tsx',
      'frontend/apps/ops/src/workspace/ops-jurisdiction-panel.tsx',
      'frontend/apps/ops/src/workspace/ops-jurisdiction-balances.tsx',
      'frontend/apps/ops/src/workspace/ops-jurisdiction-view.ts',
      'frontend/apps/ops/src/workspace/ops-architect-panel.tsx',
      'frontend/apps/ops/src/workspace/ops-brainvault-panel.tsx',
      'frontend/apps/ops/src/workspace/ops-database-inspector.tsx',
      'frontend/apps/ops/src/workspace/ops-graph-panel.tsx',
      'frontend/apps/ops/src/workspace/ops-graph-scene.ts',
      'frontend/apps/ops/src/workspace/ops-graph-world.ts',
      'frontend/apps/ops/src/workspace/ops-graph-preferences.ts',
      ...
      'frontend/bridges/browser-runtime-context.ts',
      'frontend/bridges/browser-runtime-session.ts',
      ...
      'frontend/packages/runtime-client/src/indexed-db-inspector-key.ts',
      'frontend/packages/runtime-client/src/indexed-db-inspector-object.ts',
      'frontend/packages/runtime-client/src/indexed-db-inspector-value.ts',
      'frontend/apps/ops/src/workspace/ops-wallet-panel.tsx',
      'frontend/packages/runtime-client/src/scenario-solvency.ts',
