...
export const CAPABILITIES = [
  ...
  },
  {
    ...
    currentSources: [
      ...
      'frontend/bridges/vault/recovery-settings.ts',
      'frontend/bridges/wallet/entity-factory.ts',
      'frontend/bridges/wallet/entity-panel-model.ts',
      ...
      'frontend/bridges/wallet/onboarding-runtime-projection.ts',
      'frontend/bridges/wallet/onboarding-targets.ts',
  ...
  },
  {
    ...
    behavior: [
      ...
      'React-owned orderbooks and same-j commands; cross-j submission/cancel targeting implemented, cancellation finality blocked by B8; lossless Activity blocked by B2',
    ],
    status: 'implemented',
  },
  {
  ...
  },
  {
    ...
    currentSources: [
      ...
      'frontend/packages/browser/src/display-preferences-source.ts',
      'frontend/packages/browser/src/theme-document.ts',
      'frontend/packages/browser/src/themes.ts',
      'frontend/packages/browser/src/ui-style.ts',
      'frontend/packages/browser/src/settings-store.ts',
