...
export const CAPABILITIES = [
  ...
  },
  {
    ...
    behavior: [
      ...
      'framework-neutral Entity workspace deep-link state, top-level section registry, strict identity/context, committed reserve, committed-board, paged Account frame-header, and public profile projections',
      'React candidate-only identity-first Entity shell with canonical hash-backed tabs, a tab-confined remote Runtime read boundary, and read-only Assets, Ownership, Accounts, and profile evidence',
