...
export const CAPABILITIES = [
  ...
  },
  {
    ...
    behavior: [
      ...
      'React candidate-only identity-first Entity shell with canonical hash-backed tabs, a tab-confined remote Runtime read boundary, read-only Assets, Ownership, Accounts, filtered and paged persisted activity, Consensus, and profile evidence, plus shared-storage Display controls and exact historical-frame navigation',
