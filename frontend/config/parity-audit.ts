...
export const RETAINED_ROUTE_PARITY = [
  ...
  { id: 'wallet-address', pathname: '/address', representativePath: '/address', sveltePage: 'frontend/src/routes/address/+page.svelte', intendedOwner: 'wallet', implementation: 'missing', browserEvidence: 'missing', reactSource: null, focusedTests: [], browserTests: [], gapIds: ['wallet-address-route'] },
  { id: 'wallet-address-entity', pathname: '/address/:entityId', representativePath: '/address/0xabc', sveltePage: 'frontend/src/routes/address/[entityId]/+page.svelte', intendedOwner: 'wallet', implementation: 'missing', browserEvidence: 'missing', reactSource: null, focusedTests: [], browserTests: [], gapIds: ['wallet-address-route'] },
