...
export const PARITY_GAPS = [
  { id: 'ops-workspace-route', kind: 'implementation', capabilityIds: ['ops-workspace'], routeIds: ['embed'], evidenceSources: ['frontend/apps/ops/src/ops-app.tsx', 'frontend/apps/ops/src/ops-model.ts', 'frontend/apps/ops/src/ops-entity-workspace.tsx', 'frontend/apps/ops/src/ops-entity-workspace-projection.ts', 'frontend/apps/ops/src/ops-display-preferences.ts', 'frontend/apps/ops/src/ops-entity-workspace-activity-controller.ts', 'frontend/apps/ops/src/ops-entity-workspace-history.ts', 'frontend/apps/ops/src/ops-entity-workspace-history-controller.ts', 'frontend/packages/browser/src/display-preferences.ts', 'frontend/packages/runtime-client/src/entity-workspace-activity.ts', 'frontend/packages/runtime-client/src/entity-workspace-consensus-evidence.ts', 'frontend/packages/runtime-client/src/entity-workspace-hub-policy.ts', 'frontend/packages/runtime-client/src/entity-workspace-settings-summary.ts', 'frontend/packages/runtime-client/src/entity-workspace-time-machine.ts', 'frontend/packages/ui/src/entity-workspace-activity-panel.tsx', 'frontend/packages/ui/src/entity-workspace-activity-row.tsx', 'frontend/packages/ui/src/entity-workspace-activity-tone.ts', 'frontend/packages/ui/src/entity-workspace-consensus-panel.tsx', 'frontend/packages/ui/src/entity-workspace-display-panel.tsx', 'frontend/packages/ui/src/entity-workspace-profile-panel.tsx', 'frontend/packages/ui/src/entity-workspace-time-machine.tsx'], nextSlice: 'Continue the authorized Entity workspace subprogram behind the internal candidate route; keep /embed canonical until parity and WP10 cutover authority are complete.' },
