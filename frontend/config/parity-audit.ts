...
const siteRouteBrowser = ['frontend/tests/react-candidate/site-routes.spec.ts'] as const;
...
export const RETAINED_ROUTE_PARITY = [
  ...
  { id: 'install', pathname: '/install', representativePath: '/install', sveltePage: 'frontend/src/routes/install/+page.svelte', intendedOwner: 'site', implementation: 'complete', browserEvidence: 'covered', reactSource: 'frontend/apps/site/src/install-page.tsx', focusedTests: ['tests/frontend/tooling/frontend-site-pilot.test.ts'], browserTests: siteRouteBrowser, gapIds: ['per-surface-browser-isolation'] },
  { id: 'rcpan', pathname: '/rcpan', representativePath: '/rcpan', sveltePage: 'frontend/src/routes/rcpan/+page.svelte', intendedOwner: 'site', implementation: 'complete', browserEvidence: 'covered', reactSource: 'frontend/apps/site/src/rcpan-page.tsx', focusedTests: ['tests/frontend/tooling/frontend-rcpan-pilot.test.ts'], browserTests: siteRouteBrowser, gapIds: ['per-surface-browser-isolation'] },
  { id: 'releases', pathname: '/releases', representativePath: '/releases', sveltePage: 'frontend/src/routes/releases/+page.svelte', intendedOwner: 'site', implementation: 'complete', browserEvidence: 'covered', reactSource: 'frontend/apps/site/src/releases-page.tsx', focusedTests: ['tests/frontend/tooling/frontend-releases-pilot.test.ts'], browserTests: siteRouteBrowser, gapIds: ['per-surface-browser-isolation'] },
  { id: 'reviews', pathname: '/reviews', representativePath: '/reviews', sveltePage: 'frontend/src/routes/reviews/+page.svelte', intendedOwner: 'site', implementation: 'complete', browserEvidence: 'covered', reactSource: 'frontend/apps/site/src/reviews-page.tsx', focusedTests: ['tests/frontend/tooling/frontend-reviews-pilot.test.ts'], browserTests: siteRouteBrowser, gapIds: ['per-surface-browser-isolation'] },
  { id: 'unicast', pathname: '/unicast', representativePath: '/unicast', sveltePage: 'frontend/src/routes/unicast/+page.svelte', intendedOwner: 'site', implementation: 'complete', browserEvidence: 'covered', reactSource: 'frontend/apps/site/src/unicast-page.tsx', focusedTests: ['tests/frontend/tooling/frontend-unicast-pilot.test.ts'], browserTests: siteRouteBrowser, gapIds: ['per-surface-browser-isolation'] },
  { id: 'market-cap', pathname: '/market-cap', representativePath: '/market-cap', sveltePage: 'frontend/src/routes/market-cap/+page.svelte', intendedOwner: 'site', implementation: 'complete', browserEvidence: 'covered', reactSource: 'frontend/apps/site/src/market-cap-page.tsx', focusedTests: ['tests/frontend/tooling/frontend-market-cap-pilot.test.ts'], browserTests: siteRouteBrowser, gapIds: ['per-surface-browser-isolation'] },
...
export const CAPABILITY_PARITY = [
  { capabilityId: 'site-public-information', gapIds: ['per-surface-browser-isolation'] },
