...
export const PARITY_GAPS = [
  { id: 'wallet-irreversible-identity', kind: 'implementation', capabilityIds: ['wallet-shell-and-identity'], routeIds: ['wallet-app'], evidenceSources: ['frontend/apps/wallet/src/identity-recovery.tsx', 'frontend/apps/wallet/src/wallet-embedded-runtime.ts', 'frontend/bridges/wallet-canonical-vault-runtime.ts', 'frontend/packages/browser/src/wallet-runtime-opening.ts', 'frontend/src/lib/stores/vault/walletRuntimeOpeningAdapter.ts', 'frontend/src/lib/components/Views/RuntimeCreation.svelte', 'frontend/config/wallet-flow-audit.ts'], nextSlice: 'Add React recovery-candidate selection and Brain Vault derivation while preserving the canonical recovery and vault adapters.' },
