...
export const PARITY_GAPS = [
  { id: 'wallet-irreversible-identity', kind: 'implementation', capabilityIds: ['wallet-shell-and-identity'], routeIds: ['wallet-app'], evidenceSources: ['frontend/apps/wallet/src/identity-recovery.tsx', 'frontend/packages/browser/src/wallet-runtime-opening.ts', 'frontend/src/lib/components/Views/RuntimeCreation.svelte', 'frontend/config/wallet-flow-audit.ts'], nextSlice: 'Wire the React identity review through the shared Runtime-opening executor and canonical vault adapter.' },
