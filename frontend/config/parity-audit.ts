...
export const RETAINED_ROUTE_PARITY = [
  ...
  { id: 'embed', pathname: '/embed', representativePath: '/embed', sveltePage: 'frontend/src/routes/embed/+page.svelte', intendedOwner: 'ops', implementation: 'partial', browserEvidence: 'partial', reactSource: 'frontend/apps/ops/src/ops-entity-workspace.tsx', focusedTests: ['tests/frontend/ops/frontend-ops-entity-workspace.test.ts', 'tests/frontend/ops/frontend-ops-display-preferences.test.ts'], browserTests: opsBrowser, gapIds: ['ops-workspace-route'] },
...
export const PARITY_GAPS = [
  { id: 'ops-workspace-route', kind: 'implementation', capabilityIds: ['ops-workspace'], routeIds: ['embed'], evidenceSources: ['frontend/apps/ops/src/ops-app.tsx', 'frontend/apps/ops/src/ops-model.ts', 'frontend/apps/ops/src/ops-entity-workspace.tsx', 'frontend/apps/ops/src/ops-entity-workspace-projection.ts', 'frontend/apps/ops/src/ops-display-preferences.ts', 'frontend/packages/browser/src/display-preferences.ts', 'frontend/packages/runtime-client/src/entity-workspace-consensus-evidence.ts', 'frontend/packages/ui/src/entity-workspace-consensus-panel.tsx', 'frontend/packages/ui/src/entity-workspace-display-panel.tsx'], nextSlice: 'Continue the authorized Entity workspace subprogram behind the internal candidate route; keep /embed canonical until parity and WP10 cutover authority are complete.' },
