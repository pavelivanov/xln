...
export const RETAINED_ROUTE_PARITY = [
  ...
  { id: 'embed', pathname: '/embed', representativePath: '/embed', sveltePage: 'frontend/src/routes/embed/+page.svelte', intendedOwner: 'ops', implementation: 'partial', browserEvidence: 'partial', reactSource: 'frontend/apps/ops/src/workspace/ops-workspace.tsx', focusedTests: ['tests/frontend/ops/frontend-ops-entity-workspace.test.ts', 'tests/frontend/ops/frontend-ops-display-preferences.test.ts', 'tests/frontend/ops/frontend-ops-entity-time-machine.test.ts', 'tests/frontend/ops/frontend-ops-entity-activity-ledger.test.ts', 'tests/frontend/workspace/entity-workspace-profile-update.test.ts'], browserTests: opsBrowser, gapIds: ['ops-workspace-route'] },
...
export const PARITY_GAPS = [
  { id: 'ops-workspace-route', kind: 'implementation', capabilityIds: ['ops-workspace'], routeIds: ['embed'], evidenceSources: ['frontend/apps/ops/src/ops-app.tsx', 'frontend/apps/ops/src/ops-model.ts', 'frontend/apps/ops/src/ops-entity-workspace.tsx', 'frontend/apps/ops/src/ops-entity-workspace-projection.ts', 'frontend/apps/ops/src/ops-entity-workspace-profile-command.ts', 'frontend/apps/ops/src/ops-entity-workspace-owner.ts', 'frontend/apps/ops/src/ops-display-preferences.ts', 'frontend/apps/ops/src/ops-entity-workspace-activity-controller.ts', 'frontend/apps/ops/src/ops-entity-workspace-history.ts', 'frontend/apps/ops/src/ops-entity-workspace-history-controller.ts', 'frontend/packages/browser/src/display-preferences.ts', 'frontend/packages/runtime-client/src/entity-workspace-activity.ts', 'frontend/packages/runtime-client/src/entity-workspace-consensus-evidence.ts', 'frontend/packages/runtime-client/src/entity-workspace-hub-policy.ts', 'frontend/packages/runtime-client/src/entity-workspace-profile-update.ts', 'frontend/packages/runtime-client/src/entity-workspace-settings-summary.ts', 'frontend/packages/runtime-client/src/entity-workspace-time-machine.ts', 'frontend/packages/ui/src/entity-workspace-activity-panel.tsx', 'frontend/packages/ui/src/entity-workspace-activity-row.tsx', 'frontend/packages/ui/src/entity-workspace-activity-tone.ts', 'frontend/packages/ui/src/entity-workspace-consensus-panel.tsx', 'frontend/packages/ui/src/entity-workspace-display-panel.tsx', 'frontend/packages/ui/src/entity-workspace-profile-editor.tsx', 'frontend/packages/ui/src/entity-workspace-profile-panel.tsx', 'frontend/packages/ui/src/entity-workspace-time-machine.tsx'], nextSlice: 'Finish remaining reachable Ops controls and shared Wallet action parity; preserve the public /embed layout boundary, then verify the complete candidate before authorized canonical cutover.' },
  { id: 'wallet-operation-parity', kind: 'implementation', capabilityIds: ['wallet-finance', 'wallet-payments-and-markets', 'wallet-shell-and-identity'], routeIds: ['wallet-app'], evidenceSources: ['plans/react-frontend-migration.md', 'frontend/apps/wallet/src/wallet-entity-evidence.tsx', 'frontend/apps/wallet/src/wallet-lending.tsx'], nextSlice: 'Finish Ownership commands, settlement approval/execution and cross-j commands; preserve the explicit backend admission and read-projection dependencies.' },
  { id: 'framework-isolation', kind: 'implementation', capabilityIds: ['wallet-browser-lifecycle'], routeIds: ['wallet-app'], evidenceSources: ['frontend/bridges/wallet-canonical-vault-runtime.ts', 'tests/frontend/tooling/frontend-shared-boundaries.test.ts'], nextSlice: 'Move retained canonical helpers and lifecycle stores to framework-neutral owners; direct bridge store reads are neutral, but transitive Svelte dependencies remain.' },
