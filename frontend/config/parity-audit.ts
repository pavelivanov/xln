...
export const RETAINED_ROUTE_PARITY = [
  ...
  { id: 'wallet-address', pathname: '/address', representativePath: '/address', sveltePage: 'frontend/src/routes/address/+page.svelte', intendedOwner: 'wallet', implementation: 'partial', browserEvidence: 'partial', reactSource: 'frontend/apps/wallet/src/wallet-address.tsx', focusedTests: ['tests/frontend/runtime/frontend-wallet-address.test.ts'], browserTests: walletBrowser, gapIds: ['wallet-address-route'] },
  { id: 'wallet-address-entity', pathname: '/address/:entityId', representativePath: '/address/0xabc', sveltePage: 'frontend/src/routes/address/[entityId]/+page.svelte', intendedOwner: 'wallet', implementation: 'partial', browserEvidence: 'partial', reactSource: 'frontend/apps/wallet/src/wallet-address.tsx', focusedTests: ['tests/frontend/runtime/frontend-wallet-address.test.ts'], browserTests: walletBrowser, gapIds: ['wallet-address-route'] },
  ...
  { id: 'embed', pathname: '/embed', representativePath: '/embed', sveltePage: 'frontend/src/routes/embed/+page.svelte', intendedOwner: 'ops', implementation: 'partial', browserEvidence: 'partial', reactSource: 'frontend/apps/ops/src/ops-entity-workspace.tsx', focusedTests: ['tests/frontend/ops/frontend-ops-entity-workspace.test.ts'], browserTests: opsBrowser, gapIds: ['ops-workspace-route'] },
...
export const PARITY_GAPS = [
  ...
  { id: 'wallet-address-route', kind: 'implementation', capabilityIds: ['wallet-shell-and-identity', 'wallet-finance'], routeIds: ['wallet-address', 'wallet-address-entity'], evidenceSources: ['frontend/apps/wallet/src/wallet-address-source.ts', 'frontend/apps/wallet/src/wallet-address.tsx', 'frontend/tests/react-candidate/wallet.spec.ts'], nextSlice: 'Connect imported Runtime selection and prove populated directory, detail, and history states in a real browser.' },
...
export const CAPABILITY_PARITY = [
  ...
  { capabilityId: 'wallet-shell-and-identity', gapIds: ['wallet-app-browser-depth', 'wallet-irreversible-identity', 'wallet-address-route'] },
  ...
  { capabilityId: 'wallet-finance', gapIds: ['wallet-app-browser-depth', 'wallet-address-route'] },
