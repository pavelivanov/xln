...
export const WALLET_FLOW_AUDIT = [
  ...
  },
  {
    ...
    sources: [
      ...
      'frontend/apps/wallet/src/wallet-account-workspace.tsx',
      'frontend/apps/wallet/src/wallet-account-context.ts',
      'frontend/apps/wallet/src/wallet-manage.tsx',
      'frontend/apps/wallet/src/wallet-move.tsx',
      'frontend/apps/wallet/src/wallet-lending.tsx',
      'frontend/apps/wallet/src/wallet-history.tsx',
      'frontend/bridges/wallet-canonical-account-context.ts',
      'frontend/packages/ui/src/account-workspace-rail.tsx',
      'frontend/packages/runtime-client/src/account-workspace-tabs.ts',
    ],
    tests: ['frontend/tests/react-candidate/wallet-account-rail.spec.ts', 'frontend/tests/react-candidate/wallet-entity-selection.spec.ts',
      'frontend/tests/react-candidate/wallet-account-workspace.spec.ts', 'tests/frontend/account/wallet-workspace-selection.test.ts',
      'frontend/tests/react-candidate/wallet-account-commands.spec.ts',
