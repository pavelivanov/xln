...
export const PLATFORM_INVENTORY = [
  ...
  },
  {
    ...
    evidence: [
      ...
      'tests/frontend/ops/frontend-ops-entity-activity-ledger.test.ts',
      'tests/frontend/workspace/entity-workspace-consensus-evidence.test.ts',
      ...
      'tests/frontend/ops/frontend-ops-entity-time-machine.test.ts',
  ...
  },
  {
    ...
    evidence: [
      ...
      'frontend/tests/react-candidate/ops-workspace-localization.spec.ts',
      'frontend/tests/react-candidate/wallet-localization.spec.ts',
      'frontend/tests/react-candidate/ops-public-embed.spec.ts',
