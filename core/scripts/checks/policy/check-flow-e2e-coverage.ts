...
const requirements: CoverageRequirement[] = [
  ...
  {
    area: 'frontend',
    file: 'frontend/packages/runtime-client/src/account-workspace-tabs.ts',
    patterns: [
      "{ id: 'send', label: 'Pay' }",
      "{ id: 'swap', label: 'Swap' }",
      'accountWorkspaceTabsForAccounts',
    ],
  },
  {
    area: 'frontend',
    file: 'frontend/apps/wallet/src/markets/wallet-market-source.ts',
    patterns: [
      'submitOrder = async',
      'cancelOrder = async',
      'reviewCrossOrder = async',
      'if (review.plan.targetSetupInput) await this.submitInput(review.plan.targetSetupInput);',
      'submitCrossJurisdictionIntent(review.plan.crossJurisdictionIntent)',
      'cancelCrossOrder = async',
    ],
  },
  {
    area: 'frontend',
    file: 'frontend/apps/wallet/src/markets/wallet-cross-market-ticket.tsx',
    patterns: [
      'Cross-j source amount',
      'Cross-j target amount',
      'cross-j-safety-banner',
      'source.submitCrossOrder(review)',
    ],
  },
  {
    area: 'frontend',
    file: 'frontend/bridges/wallet/swap-panel-helpers.ts',
    patterns: [
  ...
  {
    area: 'frontend',
    file: 'frontend/apps/wallet/src/markets/wallet-market-pane.tsx',
    patterns: [
      'source.cancelCrossOrder(orderId)',
      'Cancel cross-j order',
    ],
  },
  {
    area: 'frontend',
    file: 'frontend/apps/wallet/src/payments/wallet-payment-send.tsx',
    patterns: [
      'Recipient amount',
      'source.submitQuotedPayment',
      'Submit quoted payment',
    ],
  },
  {
    area: 'cross-j',
