...
import {
  ...
  TESTNET_CARDS,
} from '../../../../frontend/apps/wallet/src/testnet/testnet-model';
import { resolveWalletPage } from '../../../../frontend/apps/wallet/src/wallet-model';

const ROOT = resolve(import.meta.dir, '../../../..');

describe('React wallet testnet pilot', () => {
  test('owns the exact testnet and app routes alongside the address candidate', () => {
  ...
  test('tracks the wallet shell and identity capability as implemented', () => {
    ...
    expect(capability?.currentSources).toContain('frontend/apps/wallet/src/testnet/testnet-page.tsx');
  });
});
