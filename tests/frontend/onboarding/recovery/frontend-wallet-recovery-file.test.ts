...
import { walletRecoveryFileErrorMessage } from '../../../../frontend/apps/wallet/src/identity/identity-onboarding-model';
...
describe('React wallet recovery file boundary', () => {
  ...
  test('uses a genuine encrypted Runtime bundle in browser evidence', () => {
    const fixture = read('frontend/tests/react-candidate/wallet/fixtures/wallet-recovery-fixture.ts');
