...
describe('React wallet recovery-service onboarding', () => {
  ...
  test('keeps React on public projections without importing the Svelte application', () => {
    const source = [
      readFileSync('frontend/apps/wallet/src/recovery/wallet-recovery-services.tsx', 'utf8'),
      readFileSync('frontend/apps/wallet/src/recovery/wallet-recovery-services-source.ts', 'utf8'),
    ].join('\n');
