...
} from '../../../../frontend/apps/wallet/src/diagnostics/wallet-diagnostics-model';
...
describe('React wallet diagnostics', () => {
  ...
  test('keeps the report redacted and refreshes through the canonical endpoint', () => {
    const source = readFileSync('frontend/apps/wallet/src/diagnostics/wallet-diagnostics.tsx', 'utf8');
