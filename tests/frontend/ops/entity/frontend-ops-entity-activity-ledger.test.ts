...
import { OpsEntityWorkspaceActivityController } from '../../../../frontend/apps/ops/src/entity-workspace/ops-entity-workspace-activity-controller';
import {
...
import { entityWorkspaceActivityTone } from '../../../../frontend/packages/ui/src/entity/activity/entity-workspace-activity-tone';
...
describe('React Entity persisted activity ledger', () => {
  ...
  test('keeps the visible ledger read-only and attached to live plus historical reads', async () => {
    const [panel, row, source, history] = await Promise.all([
      ...
      Bun.file('frontend/packages/ui/src/entity/activity/entity-workspace-activity-row.tsx').text(),
      Bun.file('frontend/apps/ops/src/entity-workspace/ops-entity-workspace-source.ts').text(),
      Bun.file('frontend/apps/ops/src/entity-workspace/ops-entity-workspace-history.ts').text(),
    ]);
