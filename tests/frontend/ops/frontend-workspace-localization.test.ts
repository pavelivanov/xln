...
import en from '../../../frontend/packages/browser/src/localization/locales/en.json';
import ru from '../../../frontend/packages/browser/src/localization/locales/ru.json';
import zh from '../../../frontend/packages/browser/src/localization/locales/zh.json';
import es from '../../../frontend/packages/browser/src/localization/locales/es.json';
import ja from '../../../frontend/packages/browser/src/localization/locales/ja.json';
import ko from '../../../frontend/packages/browser/src/localization/locales/ko.json';
import pt from '../../../frontend/packages/browser/src/localization/locales/pt.json';
import de from '../../../frontend/packages/browser/src/localization/locales/de.json';
import fr from '../../../frontend/packages/browser/src/localization/locales/fr.json';
import tr from '../../../frontend/packages/browser/src/localization/locales/tr.json';
