...
} from '../../../../../frontend/packages/browser/src/runtime/wallet-embedded-runtime-session';
...
describe('wallet embedded Runtime session', () => {
  ...
  test('owns one document-scoped React session behind the canonical tab lock', () => {
    const source = readFileSync('frontend/apps/wallet/src/runtime/wallet-embedded-runtime.ts', 'utf8');
    const shared = readFileSync('frontend/bridges/runtime/browser/browser-runtime-session.ts', 'utf8');
