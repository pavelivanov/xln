...
} from '../../../../frontend/apps/wallet/src/address/wallet-address-model';
import {
  resolveWalletPage,
  walletPageMetadata,
} from '../../../../frontend/apps/wallet/src/wallet-model';
import { resolveWalletAddressRuntimeAffinity } from '../../../../frontend/apps/wallet/src/address/wallet-address-runtime-affinity';
import type { StoredRemoteRuntimeImportEntry } from '../../../../frontend/packages/browser/src/runtime/session/remote-runtime-import';
...
describe('React wallet address routes', () => {
  ...
  test('keeps Runtime effects in a height-aware source and failures in the visible React surface', () => {
    ...
    const affinity = readFileSync('frontend/apps/wallet/src/address/wallet-address-runtime-affinity.ts', 'utf8');
