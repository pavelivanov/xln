...
} from '../../../../frontend/packages/runtime-client/src/runtime/view/runtime-view-projections';
import type {
  RuntimeViewFrameModel,
} from '../../../../frontend/packages/runtime-client/src/runtime/view/runtime-view-model';
